...
opts.Display = 'Off';
opts.Robust = 'LAR';
opts.StartPoint = [1.26585800720736 -0.00417047640534355];
...
hold off
legend( h, 'm vs. a', 'exp1', 'Lower bound(a and m)', 'Upper bound(a and m)', 'm vs. a', 'Location', 'NorthEast', 'Interpreter', 'none' );
...
hold off
legend( h, 'exp1 - Residuals', 'Zero Line', 'a and m - Validation residuals', 'Location', 'NorthEast', 'Interpreter', 'none' );
% Label the coordinate axes
