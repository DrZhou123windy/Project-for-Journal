...
opts.Display = 'Off';
opts.Robust = 'LAR';
opts.StartPoint = [1.84623794668635 -0.218524637149938 -0.0011386029211681];
...
hold off
legend( h, 'm vs. a', 'power2', 'Lower bound(a and m)', 'Upper bound(a and m)', 'm vs. a', 'Location', 'NorthEast', 'Interpreter', 'none' );
...
hold off
legend( h, 'power2 - Residuals', 'Zero Line', 'a and m - Validation residuals', 'Location', 'NorthEast', 'Interpreter', 'none' );
% Label the coordinate axes
