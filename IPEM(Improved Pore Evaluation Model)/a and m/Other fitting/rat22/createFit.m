...
opts.Display = 'Off';
opts.Robust = 'LAR';
opts.StartPoint = [0.470923348517591 0.230488160211558 0.844308792695389 0.194764289567049 0.225921780972399];
...
hold off
legend( h, 'm vs. a', 'rat22', 'Lower bound(a and m)', 'Upper bound(a and m)', 'm vs. a', 'Location', 'NorthEast', 'Interpreter', 'none' );
...
hold off
legend( h, 'rat22 - Residuals', 'Zero Line', 'a and m - Validation residuals', 'Location', 'NorthEast', 'Interpreter', 'none' );
% Label the coordinate axes
